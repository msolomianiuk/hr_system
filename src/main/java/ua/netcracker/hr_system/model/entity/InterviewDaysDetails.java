...
public class InterviewDaysDetails {
    ...
    public InterviewDaysDetails(int id, int courseId, Date interviewDate, int addressId, int employeesMaxCount,
    ...
    public InterviewDaysDetails(int courseId, Date interviewDate, int addressId, int employeesMaxCount,
                                int candidateMaxCount) {
        this.courseId = courseId;
        this.interviewDate = interviewDate;
        this.addressId = addressId;
