package ua.netcracker.hr_system.model.dao.db_dao;
...
//        parameterSource.addValue("email", "admin@gmail.com");
//
//        System.out.println((jdbcTemplate.queryForObject("select * from \"hr_system\".users " +
//                        "where lower(email)=lower(:email)",
//                new UserRowMapper(), parameterSource)).toString());
//
//    }
